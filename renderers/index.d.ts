...
import { default as JsonRenderCon } from './json';
import { default as MSDocRenderer } from './msdoc';
import { default as XMLRenderer } from './xml';

export declare const DocViewerRenderers: any[];
export { BMPRenderer, HTMLRenderer, JPGRenderer, MSDocRenderer, PDFRenderer, PNGRenderer, TIFFRenderer, TXTRenderer, CSVRenderer, GIFRenderer, VideoRenderer, WebPRenderer, JsonRenderCon, XMLRenderer, };
